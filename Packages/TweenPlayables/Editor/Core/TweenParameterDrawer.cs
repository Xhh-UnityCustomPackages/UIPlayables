...
namespace TweenPlayables.Editor
{
    ...
    public class TweenParamterDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                var keyframeProperty = property.FindPropertyRelative("keyframe");
                GUIHelper.AddPropertyHeight(ref height, keyframeProperty);
                if (keyframeProperty.boolValue)
                {
        ...
        {
            var keyframeProperty = property.FindPropertyRelative("keyframe");
            GUIHelper.Field(ref position, keyframeProperty, "keyframe");
            if (keyframeProperty.boolValue)
            {
